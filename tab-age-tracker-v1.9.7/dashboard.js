...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Enhanced debugging for data parameter processing
    console.log("Checking for data parameter in URL...");
    if (dataParam) {
        try {
            ...
            console.log("Successfully parsed data object:", parsedData);
            
            // Process the tab data with detailed logging
            if (parsedData.tabData && parsedData.tabData.tabs) {
                console.log("Found valid tab data structure with tabs array:", 
                            parsedData.tabData.tabs.length + " tabs found");
