          ...
          try {
            ...
            if (useServerDashboard) {
              ...
              try {
                ...
                try {
                  // Format the data for the dashboard - fix data format to match what dashboard.js expects
                  const dashboardData = {
                    tabData: {
                      tabs: data.tabData || []
                    },
                  ...
                  // Convert the formatted data to a base64 string
                  const dataString = JSON.stringify(dashboardData);
                  const encodedData = btoa(encodeURIComponent(dataString));
                  
                  console.log("Data formatted for dashboard", dashboardData);
