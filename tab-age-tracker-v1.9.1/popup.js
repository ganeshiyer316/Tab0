  ...
  chrome.storage.local.get(['tabData', 'tabHistory', 'peakTabCount'], (data) => {
    ...
    chrome.storage.local.get(['settings'], (settingsData) => {
      ...
      if (useServerDashboard) {
        ...
        chrome.tabs.create({ url: fullServerUrl });
        ...
        const dashboardUrl = `${baseUrl}?data=${encodedData}`;
  ...
  chrome.storage.local.get(['tabData', 'tabHistory', 'peakTabCount'], (data) => {
    ...
    chrome.storage.local.get(['settings'], (settingsData) => {
      ...
      if (useServerDashboard) {
        ...
        chrome.tabs.create({ url: serverSearchUrl });
        ...
        // Ensure we use the correct path to dashboard.html with search parameter
